...
Add-ons for the currently spawned vehicle will be displayed. Add-ons can be downloaded from the [Repository](https://forum.rigsofrods.org/resources/categories/addons.15/) and placed into the `mods` folder just like vehicles and terrains.
